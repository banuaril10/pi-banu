...
<input type="hidden" id="price" value="45px"  placeholder="Ukuran Font Harga">
		...
		function get_data_pricetag($hn, $ad_org_id){
			...
			CURLOPT_URL => "https://pi.idolmartidolaku.com/api/action.php?modul=inventory&act=list_price_tag",
			...
			<form action="" method="GET">
			 ...
			 <table>
				...
				<select id="headerpromo" name="headerpromo" class="form-control text-search">
						...
						<option value="">Pilih Header Promo</option>
						<?php	
						$json_url = "https://pi.idolmartidolaku.com/api/action.php?modul=inventory&act=list_header_promo";
						...
						foreach ($arr as $row1) { ?>
							...
							<option value="<?php echo $row1['headername']; ?>"><?php echo $row1['headername']; ?></option>
				...
				<button class="btn btn-danger" type="button" id="btn-cetak-tinta"><div class="item1"><b>CETAK HARGA PROMO</b></div></button>
					...
					<table class="table table-bordered" id="example">
						...
						<?php if($q_stock > 0){ ?>
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['name']; ?>|<?php echo $row['normal']; ?>|<?php echo date('Y-m-d'); ?>|<?php echo $row['rack']; ?>||<?php echo $row['afterdiscount']; ?>|<?php echo $row['todate']; ?>||<?php echo $barcode; ?>"></td>
						...
						<?php }else{ ?>
							...
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['name']; ?>|<?php echo $row['normal']; ?>|<?php echo date('Y-m-d'); ?>|<?php echo $row['rack']; ?>||<?php echo $row['afterdiscount']; ?>|<?php echo $row['todate']; ?>||<?php echo $row['barcode']; ?>"></td>
								<td scope="row"><?php echo $no; ?></td>
								<td><?php echo $row['sku']; ?></td>
								<td><?php echo $row['name']; ?></td>
								<td><?php echo $row['normal']; ?></td>
