				...
				<button class="btn btn-danger" type="button" id="btn-cetak-tinta"><div class="item1"><b>CETAK HARGA PROMO</b></div></button>
					...
					<table class="table table-bordered" id="example">
						...
						?>
							...
							<tr>
								<td><input type="checkbox" id="checkbox" name="checkbox[]" value="<?php echo $row['sku']; ?>|<?php echo $row['name']; ?>|<?php echo $row['price']; ?>|<?php echo $row['tgl_sekarang']; ?>|<?php echo $row['rack_name']; ?>|<?php echo $row['shortcut']; ?>|<?php echo $harga_last; ?>|<?php echo $tgl_todate; ?>|<?php echo $row['tag']; ?>|<?php echo $row['barcode']; ?>"></td>
